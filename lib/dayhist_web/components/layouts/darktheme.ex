defmodule DayhistWeb.Components.ToggleTheme do
  ...
  def render(assigns) do
    ...
    <button
      ...
      class="text-grey-800 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-300 rounded-lg text-sm"
    >
      <svg
